...
int main( int argc, char** argv )
{
    ...
    //读取图像
    frame1.rgb = cv::imread( "/home/dyx/slam_learner/data/rgb1.png" );
    frame1.depth = cv::imread( "/home/dyx/slam_learner/data/depth1.png", -1);
    frame2.rgb = cv::imread( "/home/dyx/slam_learner/data/rgb2.png" );
    frame2.depth = cv::imread( "/home/dyx/slam_learner/data/depth2.png", -1 );

    // 提取特征并计算描述子
    cout<<"extracting features"<<endl;
    //string detecter = pd.getData( "detector" );
    //cout<<"frame1.desp.empty()"<<frame1.desp.empty()<<endl;
    ...
    *output += *cloud2;
    pcl::io::savePCDFile("/home/dyx/slam_learner/data/result.pcd", *output);
